                ...
                <form action="" method="post" class="formtindakan">
                    <div class="input_fields_wrap">
                        ...
                        <div class="form-group">
                            <input hidden type="text" class="form-control" id="jenisform2" name="jenisform2" value="{{ $jenisform }}">
                            <input hidden type="text" class="form-control" id="unitujuan" name="unitujuan" value="{{ $unittujuan }}">
                            <select disabled class="form-control" name="dokterpemeriksa" id="dokterpemeriksa">
                                @foreach ($dokter as $d)
                                <option value="{{ $d->kode_dokter }}" @if( $d->kode_dokter == $dok_log ) selected @endif>{{ $d->nama_dokter }}</option>
                                @endforeach
                            </select>
                        </div>
