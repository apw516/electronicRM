        ...
        <form action="" class="simpanrmanak">
            <table style="font-family:calibri" class="table table-md text-md">
                <tr>
                    ...
                    <td><input readonly id="tgldanjamkunjungan_pasienanak" class="form-control form-control-sm"
                            name="tgldanjamkunjungan_pasienanak" id="tgldanjamkunjungan_pasienanak"
                            value="{{ $tglmasuk }}"></td>
                </tr>
                <tr>
                    <td>Tanggal & Jam Pengkajian</td>
                    <td><input readonly id="tgldanjampengkajian_pasienanak" name="tgldanjampengkajian_pasienanak"
                            class="form-control form-control-sm" value="{{ $now }}"></td>
                </tr>
                <tr>
                    <td>Keluhan Utama</td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <div class="input-group date" id="reservationdate" data-target-input="nearest">
                            <input type="text" id="tekanandarah_pasienanak" name="tekanandarah_pasienanak"
                    ...
                    <td>
                        <div class="input-group date" id="reservationdate" data-target-input="nearest">
                            <input type="text" id="frekuensinadi_pasienanak" name="frekuensinadi_pasienanak"
                                class="form-control form-control-sm" />
                            <div class="input-group-append">
                ...
                <tr>
                    ...
                    <td>
                        <div class="input-group date" id="reservationdate" data-target-input="nearest">
                            <input type="text" id="frekuensinapas_pasienanak" name="frekuensinapas_pasienanak"
                                class="form-control form-control-sm" />
                            <div class="input-group-append">
                                <div class="input-group-text text-xs">X / Menit</div>
                            </div>
                    ...
                    <td>
                        <div class="input-group date" id="reservationdate" data-target-input="nearest">
                            <input type="text" id="suhu_pasienanak" name="suhu_pasienanak"
                                class="form-control form-control-sm" />
                            <div class="input-group-append">
                ...
                <tr>
                    ...
                    <td colspan="4">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input ml-2 mr-3" type="radio" name="anakkandung_pasienanak"
                                id="anakkandung_pasienanak" value="Tidak">
                            <label class="form-check-label" for="inlineRadio1">Tidak</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input ml-2 mr-3" type="radio" name="anakkandung_pasienanak"
                                id="anakkandung_pasienanak" value="Ya" checked>
                    ...
                    <td colspan="4">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input ml-2 mr-3" type="radio"
                                name="gangguantumbuhkembang_pasienanak" id="gangguantumbuhkembang_pasienanak"
                                value="Tidak" checked>
                            <label class="form-check-label" for="inlineRadio1">Tidak</label>
                        </div>
                        <div class="form-check form-check-inline">
                ...
                <tr>
                    ...
                    <td colspan="4">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input ml-2 mr-3" type="radio" name="kekerasanfisik_pasienanak"
                                id="kekerasanfisik_pasienanak" value="Tidak" checked>
                            <label class="form-check-label" for="inlineRadio1">Tidak</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input ml-2 mr-3" type="radio" name="kekerasanfisik_pasienanak"
                                id="kekerasanfisik_pasienanak" value="Ya">
                            <label class="form-check-label" for="inlineRadio1">Ya</label>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="4">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input ml-2 mr-3" type="radio" name="tinggalbersama_pasienanak"
                                id="tinggalbersama_pasienanak" value="Orang Tua" checked>
                            <label class="form-check-label" for="inlineRadio1">Orang Tua</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input mr-3" type="radio" name="tinggalbersama_pasienanak"
                                id="tinggalbersama_pasienanak" value="Lainya">
                ...
                <tr>
                    ...
                    <td colspan="4">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input ml-2 mr-3" type="radio" name="pekerjaan_pasienanak"
                                id="pekerjaan_pasienanak" value="5">
                            <label class="form-check-label" for="inlineRadio1">PNS/TNI/POLRI</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input mr-3" type="radio" name="pekerjaan_pasienanak"
                                id="pekerjaan_pasienanak" value="3">
                            <label class="form-check-label" for="inlineRadio2">Wiraswasta</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input ml-2 mr-3" type="radio" name="pekerjaan_pasienanak"
                                id="pekerjaan_pasienanak" value="15">
                            <label class="form-check-label" for="inlineRadio1">Pegawai
                                Swasta</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input mr-3" type="radio" name="pekerjaan_pasienanak"
                                id="pekerjaan_pasienanak" value="6" checked>
                ...
                <tr>
                    ...
                    <td colspan="4">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input ml-2 mr-3" type="radio" name="agama_pasienanak"
                                id="agama_pasienanak" value="1">
                            <label class="form-check-label" for="inlineRadio1">Islam</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input mr-3" type="radio" name="agama_pasienanak"
                                id="agama_pasienanak" value="2">
                            <label class="form-check-label" for="inlineRadio2">Kristen</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input ml-2 mr-3" type="radio" name="agama_pasienanak"
                                id="agama_pasienanak" value="4">
                            <label class="form-check-label" for="inlineRadio1">Hindu</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input mr-3" type="radio" name="agama_pasienanak"
                                id="agama_pasienanak" value="5">
                            <label class="form-check-label" for="inlineRadio2">Budha</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input mr-3" type="radio" name="agama_pasienanak"
                                id="agama_pasienanak" value="8">
                            <label class="form-check-label" for="inlineRadio2">Lain -
                                lain</label>
                        </div>
                    </td>
                ...
                <tr>
                    ...
                    <td colspan="4">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input ml-2 mr-3" type="radio" name="alatbantu_pasienanak"
                                id="alatbantu_pasienanak" value="Tidak" checked>
                            <label class="form-check-label" for="inlineRadio1">Tidak</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input ml-2 mr-3" type="radio" name="alatbantu_pasienanak"
                                id="alatbantu_pasienanak" value="Tongkat">
                            <label class="form-check-label" for="inlineRadio1">Tongkat</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input ml-2 mr-3" type="radio" name="alatbantu_pasienanak"
                                id="alatbantu_pasienanak" value="Kursi Roda">
                ...
                <tr>
                    ...
                    <td colspan="4">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input  ml-2 mr-3 cacat_pasienanak1" skor="1"
                                type="radio" name="cacat_pasienanak" id="cacat_pasienanak" value="Tidak" checked>
                            <label class="form-check-label" for="inlineRadio1">Tidak</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input  ml-2 mr-3 cacat_pasienanak1" skor="2"
                                type="radio" name="cacat_pasienanak" id="cacat_pasienanak" value="Ada">
                            <label class="form-check-label" for="inlineRadio1">Ada</label>
                        </div>
                        <input type="text" class="form-control form-control-sm" id="namacacatubuh"
                            name="namacacatubuh" placeholder="Sebutkan cacat tubuh ..." value="tidak ada">
                ...
                <tr>
                    ...
                    <td colspan="4">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input ml-2 mr-3 nyeri_pasienanak" type="radio"
                                name="nyeri_pasienanak" skor="1" id="nyeri_pasienanak" value="Tidak" checked>
                            <label class="form-check-label" for="inlineRadio1">Tidak</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input mr-3 nyeri_pasienanak" type="radio"
                                name="nyeri_pasienanak" skor="2" id="nyeri_pasienanak" value="Ya">
                            <label class="form-check-label" for="inlineRadio2">Ya</label>
                        </div>
                        <input type="text" id="skalanyeripasienanak" name="skalanyeripasienanak"
                            class="form-control form-control-sm" placeholder="skala nyeri ...">
                        <img src="{{ asset('public/img/skalanyeri.jpg') }}" width="350px" alt="">
                    </td>
                </tr>
            </table>
            <table style="font-family:calibri" class="table table-bordered table-md text-md">
                <thead>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input type="radio" class="text-center form-check-input wajah_pasienanak"
                                    name="wajah_pasienanak" id="wajah_pasienanak"
                                    value="Tidak ada ekpresi khusus, senyum" skor="0" checked>
                                <label class="form-check-label" for="inlineRadio2"> Tidak ada ekpresi khusus,
                                    senyum</label>
                            </div>
                        </td>
                        <td rowspan="3">
                    ...
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input type="radio" class="text-center form-check-input wajah_pasienanak"
                                    name="wajah_pasienanak" id="wajah_pasienanak"
                                    value="Menyeringa, mengerukan dahi, tampak tidak teratrik (kadang-kadanag)"
                                    skor="1">
                                <label class="form-check-label" for="inlineRadio2"> Menyeringa, mengerukan dahi,
                                    tampak tidak teratrik (kadang-kadanag)</label>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input type="radio" class="text-center form-check-input wajah_pasienanak"
                                    name="wajah_pasienanak" id="wajah_pasienanak"
                                    value="Dagu gemetar, gerutu berulang(sering)" skor="2">
                                <label class="form-check-label" for="inlineRadio2"> Dagu gemetar, gerutu
                                    berulang(sering)</label>
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input type="radio" class="text-center form-check-input kaki_pasienanak"
                                    name="kaki_pasienanak" id="kaki_pasienanak" value="Posisi normal atau santai"
                                    skor="0" checked>
                    ...
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input type="radio" class="text-center form-check-input kaki_pasienanak"
                                    name="kaki_pasienanak" id="kaki_pasienanak" value="Gelisah, tegang"
                                    skor="1">
                    ...
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input type="radio" class="text-center form-check-input kaki_pasienanak"
                                    name="kaki_pasienanak" id="kaki_pasienanak" value="menendang, kaki tertekuk"
                                    skor="2">
                    ...
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input type="radio" class="text-center form-check-input activity_pasienanak"
                                    name="activity_pasienanak" id="activity_pasienanak"
                                    value="Berbaring tenang, posisi normal, gerakan mudah" skor="0" checked>
                                <label class="form-check-label" for="inlineRadio2"> Berbaring tenang, posisi normal,
                                    gerakan mudah</label>
                            </div>
                        </td>
                        <td rowspan="3">
                    ...
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input type="radio" class="text-center form-check-input activity_pasienanak"
                                    name="activity_pasienanak" id="activity_pasienanak"
                                    value="Menggeliat, tidak bisa diam, tegang" skor="1">
                                <label class="form-check-label" for="inlineRadio2"> Menggeliat, tidak bisa diam,
                                    tegang</label>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input type="radio" class="text-center form-check-input activity_pasienanak"
                                    name="activity_pasienanak" id="activity_pasienanak" value="kaku atau teggang"
                                    skor="2">
                    ...
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input type="radio" class="text-center form-check-input cry_pasienanak"
                                    name="cry_pasienanak" id="cry_pasienanak" value="tidak menangis" skor="0"
                                    checked>
                    ...
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input type="radio" class="text-center form-check-input cry_pasienanak"
                                    name="cry_pasienanak" id="cry_pasienanak"
                                    value="Merintih, merengek, kadang-kadang mengeluh" skor="1">
                                <label class="form-check-label" for="inlineRadio2"> Merintih, merengek, kadang-kadang
                                    mengeluh</label>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input type="radio" class="text-center form-check-input cry_pasienanak"
                                    name="cry_pasienanak" id="cry_pasienanak" value="terus menangis atau teriak"
                                    skor="2">
                    ...
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input type="radio" class="text-center form-check-input consolabity_pasienanak"
                                    name="consolabity_pasienanak" id="consolabity_pasienanak" value="Rileks"
                                    skor="0" checked>
                    ...
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input type="radio" class="text-center form-check-input consolabity_pasienanak"
                                    name="consolabity_pasienanak" id="consolabity_pasienanak"
                                    value="Dapat ditemukan dengan sentuhan pelukan, bujukan, dialihkan"
                                    skor="1">
                                <label class="form-check-label" for="inlineRadio2"> Dapat ditemukan dengan sentuhan
                                    pelukan, bujukan, dialihkan</label>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input type="radio" class="text-center form-check-input consolabity_pasienanak"
                                    name="consolabity_pasienanak" id="consolabity_pasienanak"
                                    value="sering mengeluh, sulit dibujuk" skor="2">
                                <label class="form-check-label" for="inlineRadio2"> sering mengeluh, sulit
                                    dibujuk</label>
                            </div>
                        </td>
                    </tr>
            ...
            <table style="font-family:calibri" class="table table-bordered table-md text-md">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input type="radio" class="text-center form-check-input ekspresi_pasienanak"
                                    name="ekspresi_pasienanak" id="ekspresi_pasienanak" value="rileks"
                                    skor="0" checked>
                                <label class="form-check-label" for="inlineRadio2"> Rileks</label>
                            </div>
                        </td>
                    ...
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input type="radio" class="text-center form-check-input ekspresi_pasienanak"
                                    name="ekspresi_pasienanak" id="ekspresi_pasienanak" value="meringis"
                                    skor="1">
                    ...
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input checked type="radio" class="text-center form-check-input nangis_pasienanak"
                                    name="nangis_pasienanak" id="nangis_pasienanak" value="Tidak Menangis"
                                    skor="0">
                                <label class="form-check-label" for="inlineRadio2"> Tidak menangis</label>
                            </div>
                        </td>
                    ...
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input type="radio" class="text-center form-check-input nangis_pasienanak"
                                    name="nangis_pasienanak" id="nangis_pasienanak" value="Meringis" skor="1">
                                <label class="form-check-label" for="inlineRadio2"> Meringis</label>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input type="radio" class="text-center form-check-input nangis_pasienanak"
                                    name="nangis_pasienanak" id="nangis_pasienanak" skor="2"
                                    value="Menangis Keras">
                    ...
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input checked type="radio" class="text-center form-check-input pola_pasienanak"
                                    name="pola_pasienanak" id="pola_pasienanak" value="Rileks" skor="0">
                                <label class="form-check-label" for="inlineRadio2"> Rileks</label>
                            </div>
                        </td>
                        <td rowspan="2">
                    ...
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input type="radio" class="text-center form-check-input pola_pasienanak"
                                    name="pola_pasienanak" id="pola_pasienanak" value="Perubahan Pola Nafas"
                                    skor="1">
                    ...
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input checked type="radio" class="text-center form-check-input l_pasienanak"
                                    name="l_pasienanak" id="l_pasienanak" value="Rileks" skor="0">
                                <label class="form-check-label" for="inlineRadio2"> Rileks</label>
                            </div>
                        </td>
                        <td rowspan="2">
                    ...
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input type="radio" class="text-center form-check-input l_pasienanak"
                                    name="l_pasienanak" id="l_pasienanak" value="Fleksi" skor="0">
                    ...
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input checked type="radio" class="text-center form-check-input k_pasienanak"
                                    name="k_pasienanak" id="k_pasienanak" value="Rileks" skor="1">
                                <label class="form-check-label" for="inlineRadio2"> Rileks</label>
                            </div>
                        </td>
                        <td rowspan="2">
                    ...
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input type="radio" class="text-center form-check-input k_pasienanak"
                                    name="k_pasienanak" id="k_pasienanak" value="fleksi" skor="1">
                                <label class="form-check-label" for="inlineRadio2"> fleksi</label>
                            </div>
                        </td>
                    </tr>
                        ...
                        <td>
                            <div class="form-check form-check-inline">
                                <input checked type="radio"
                                    class="text-center form-check-input terangsang_pasienanak"
                                    name="terangsang_pasienanak" id="terangsang_pasienanak" value="Tidur"
                                    skor="0">
                    ...
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input type="radio" class="text-center form-check-input terangsang_pasienanak"
                                    name="terangsang_pasienanak" id="terangsang_pasienanak" value="Bangun"
                                    skor="0">
                    ...
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input type="radio" class="text-center form-check-input terangsang_pasienanak"
                                    name="terangsang_pasienanak" id="terangsang_pasienanak" value="Rewel"
                                    skor="1">
            ...
            <table style="font-family:calibri" class="table table-bordered table-md">
                <thead>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input type="radio" class="text-center form-check-input umur_pasienanak"
                                    name="umur_pasienanak" id="umur_pasienanak" value=" Dibawah 3 tahun"
                                    skor="4">
                    ...
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input type="radio" class="text-center form-check-input umur_pasienanak"
                                    name="umur_pasienanak" id="umur_pasienanak" value="3-7 tahun" skor="3">
                    ...
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input type="radio" class="text-center form-check-input umur_pasienanak"
                                    name="umur_pasienanak" id="umur_pasienanak" value="7-13 tahun" skor="2">
                    ...
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input type="radio" class="text-center form-check-input umur_pasienanak"
                                    name="umur_pasienanak" id="umur_pasienanak" value="Lebih 13 tahun"
                                    skor="1">
                    ...
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input type="radio" class="text-center form-check-input jk_pasienanak"
                                    name="jk_pasienanak" id="jk_pasienanak" value="Laki-laki" skor="2">
                    ...
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input type="radio" class="text-center form-check-input jk_pasienanak"
                                    name="jk_pasienanak" id="jk_pasienanak" value="Perempuan" skor="1">
                    ...
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input type="radio" class="text-center form-check-input diagnosis_pasienanak"
                                    name="diagnosis_pasienanak" id="diagnosis_pasienanak" value="Gangguan neurologis"
                                    skor="4">
                    ...
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input type="radio" class="text-center form-check-input diagnosis_pasienanak"
                                    name="diagnosis_pasienanak" id="diagnosis_pasienanak"
                                    value="Perubahan dalam oksigenasi (masalah saluran napas, dehidrasi, anemia, anorexia, sinkop, sakit kepala,)"
                                    skor="3">
                                <label class="form-check-label" for="inlineRadio2"> Perubahan dalam oksigenasi
                                    (masalah saluran napas, dehidrasi, anemia, anorexia, sinkop, sakit kepala,)</label>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input type="radio" class="text-center form-check-input diagnosis_pasienanak"
                                    name="diagnosis_pasienanak" id="diagnosis_pasienanak"
                                    value="kelaian psikis atau prilaku" skor="2">
                                <label class="form-check-label" for="inlineRadio2"> kelaian psikis atau
                                    prilaku</label>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input type="radio" class="text-center form-check-input diagnosis_pasienanak"
                                    name="diagnosis_pasienanak" id="diagnosis_pasienanak" value="Diagnosis lainya"
                                    skor="1">
                    ...
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input type="radio" class="text-center form-check-input kognitif_pasienanak"
                                    name="kognitif_pasienanak" id="kognitif_pasienanak"
                                    value="Tidak menyadari keterbatasan diri" skor="3">
                                <label class="form-check-label" for="inlineRadio2"> Tidak menyadari keterbatasan
                                    diri</label>
                            </div>
                        </td>
                        <td rowspan="3">
                    ...
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input type="radio" class="text-center form-check-input kognitif_pasienanak"
                                    name="kognitif_pasienanak" id="kognitif_pasienanak"
                                    value="Lupa akan adanya keterbatasan" skor="2">
                                <label class="form-check-label" for="inlineRadio2"> Lupa akan adanya
                                    keterbatasan</label>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input type="radio" class="text-center form-check-input kognitif_pasienanak"
                                    name="kognitif_pasienanak" id="kognitif_pasienanak"
                                    value="Orientasi baik terhadap diri sendiri" skor="1">
                                <label class="form-check-label" for="inlineRadio2"> Orientasi baik terhadap diri
                                    sendiri</label>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input type="radio" class="text-center form-check-input fl_pasienanak"
                                    name="fl_pasienanak" id="fl_pasienanak"
                                    value="Riwayat jatuh dari tempat tidur saat bayi/anak" skor="4">
                                <label class="form-check-label" for="inlineRadio2"> Riwayat jatuh dari tempat tidur
                                    saat bayi/anak</label>
                            </div>
                        </td>
                        <td rowspan="4">
                    ...
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input type="radio" class="text-center form-check-input fl_pasienanak"
                                    name="fl_pasienanak" id="fl_pasienanak"
                                    value="Pasien menggunakan alat bantu atau bpx/model" skor="3">
                                <label class="form-check-label" for="inlineRadio2"> Pasien menggunakan alat bantu atau
                                    bpx/model</label>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input type="radio" class="text-center form-check-input fl_pasienanak"
                                    name="fl_pasienanak" id="fl_pasienanak"
                                    value=" pasien di letakan di tempat tidur" skor="2">
                                <label class="form-check-label" for="inlineRadio2"> pasien di letakan di tempat
                                    tidur</label>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input type="radio" class="text-center form-check-input fl_pasienanak"
                                    name="fl_pasienanak" id="fl_pasienanak" value="Diluar ruang rawat"
                                    skor="1">
                    ...
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input type="radio" class="text-center form-check-input rsp_pasienanak"
                                    name="rsp_pasienanak" id="rsp_pasienanak" value="dalam 24 jam" skor="3">
                    ...
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input type="radio" class="text-center form-check-input rsp_pasienanak"
                                    name="rsp_pasienanak" id="rsp_pasienanak" value="dalam 48 jam" skor="2">
                    ...
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input type="radio" class="text-center form-check-input rsp_pasienanak"
                                    name="rsp_pasienanak" id="rsp_pasienanak" value="48 jam" skor="1">
                    ...
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input type="radio" class="text-center form-check-input obat_pasienanak"
                                    name="obat_pasienanak" id="obat_pasienanak"
                                    value="Bermacam obat yang digunakan : obat
                                    sedative (kecuali pasien itu, yang
                                    menggunakan sedasi dan paralisis , hiponotik,
                                    barbinurate, fenotiazen, antidepresan, laksatif/diuretik, natkotik)"
                                    skor="3">
                                <label class="form-check-label" for="inlineRadio2"> Bermacam obat yang digunakan :
                                    obat
                                    sedative (kecuali pasien itu, yang
                                    menggunakan sedasi dan paralisis , hiponotik,
                    ...
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input type="radio" class="text-center form-check-input obat_pasienanak"
                                    name="obat_pasienanak" id="obat_pasienanak"
                                    value="Penggunaan salah satu obat di atas" skor="2">
                                <label class="form-check-label" for="inlineRadio2"> Penggunaan salah satu obat di
                                    atas</label>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <div class="form-check form-check-inline">
                                <input type="radio" class="text-center form-check-input obat_pasienanak"
                                    name="obat_pasienanak" id="obat_pasienanak" value="penggunaan obat lainya"
                                    skor="1">
            ...
            <table style="font-family:calibri" class="table table-md text-md">
                ...
                <tbody>
                    <tr class="text-center">
                        <td>
                            <textarea readonly disabled name="tanggal_assesmen" class="form-control" id="tanggal_assesmen"
                                name="tanggal_assesmen" cols="30" rows="2"> {{ $now }}</textarea>
                        </td>

                        <td>
                            <textarea readonly disabled name="nama_perawat" class="form-control" id="nama_perawat" name="tanggal_assesmen"
                                cols="30" rows="2">{{ strtoupper(auth()->user()->name) }}</textarea>
