    ...
    <form action="" class="editsimpanrm2 ">
        <table class="table table-md text-md">
            <tr>
                ...
                <td><input readonly class="form-control form-control-md" name="edittgldanjamkunjungan_pasienbaru" id="tgldanjamkunjungan_pasienbaru" value="{{ $tglmasuk }}"></td>
            </tr>
            <tr>
                <td class="text-bold">Tanggal & Jam Pengkajian</td>
                <td><input readonly class="form-control form-control-md" value="{{ $now }}" id="tgldanjampengkajian_pasienbaru" name="edittgldanjampengkajian_pasienbaru"></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="4">
                    <div class="form-check form-check-inline">
                        <input class="form-check-input ml-2 mr-3" type="radio" name="editpekerjaan_pasienbaru" id="pekerjaan_pasienbaru" value="5" @if ($pasien[0]->pekerjaan == 5) checked @endif>
                        <label class="form-check-label" for="inlineRadio1">PNS/TNI/POLRI</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input mr-3" type="radio" name="editpekerjaan_pasienbaru" id="pekerjaan_pasienbaru" value="3" @if ($pasien[0]->pekerjaan == 3) checked @endif>
                        <label class="form-check-label" for="inlineRadio2">Wiraswasta</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input ml-2 mr-3" type="radio" name="editpekerjaan_pasienbaru" id="pekerjaan_pasienbaru" value="15" @if ($pasien[0]->pekerjaan == 15) checked @endif>
                        <label class="form-check-label" for="inlineRadio1">Pegawai
                            Swasta</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input mr-3" type="radio" name="editpekerjaan_pasienbaru" id="pekerjaan_pasienbaru" value="11" @if ($pasien[0]->pekerjaan == 11) checked @endif>
                        <label class="form-check-label" for="inlineRadio2">Pensiun</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input mr-3" type="radio" name="editpekerjaan_pasienbaru" id="pekerjaan_pasienbaru" value="6" @if ($pasien[0]->pekerjaan == 6) checked @endif>
            ...
            <tr>
                ...
                <td colspan="4">
                    <div class="form-check form-check-inline">
                        <input class="form-check-input ml-2 mr-3" type="radio" name="editagama_pasienbaru" id="agama_pasienbaru" value="1" @if ($pasien[0]->agama == 1) checked @endif>
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input mr-3" type="radio" name="editagama_pasienbaru" id="agama_pasienbaru" value="8" @if ($pasien[0]->agama == 8) checked @endif>
                        <label class="form-check-label" for="inlineRadio2">Lain -
                            lain</label>
                    </div>
                </td>
        ...
        <table class="table text-bold table-md text-md">
            ...
            <tbody>
                <tr class="text-center">
                    <td>
                        <textarea readonly disabled name="edittanggal_assesmen" class="form-control" id="tanggal_assesmen" cols="30" rows="2"> {{ $now }}</textarea>
                    </td>
