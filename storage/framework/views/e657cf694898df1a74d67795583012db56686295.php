<div class="container-fluid text-xs">
    ...
    <div class="card-header p-2">
        <ul class="nav nav-pills">
            ...
            <li class="nav-item"><a class="nav-link tampilresume" href="#resumemedis" data-toggle="tab" nomorrm="<?php echo e($rm); ?>">Resume Medis</a></li>
        </ul>
    </div>
    <div class="card-body ">
...
</script><?php /**PATH C:\xampp\htdocs\e-RM\resources\views/erm/pasienterpilih.blade.php ENDPATH**/ ?>