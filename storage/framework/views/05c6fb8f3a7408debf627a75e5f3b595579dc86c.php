    ...
    <div class="card-body">
        ...
        <table class="table text-bold">
            <tr>
                ...
                <td><input readonly type="text" class="form-control"  name="tanggalkunjungan_px" value="<?php echo e($tglkunjungan); ?>"></td>
                <td>Tanggal Assesmen</td>
                <td><input type="text" class="form-control" readonly name="tanggalassesmen_px" value="<?php echo e($now); ?>"></td>
            </tr>
            <tr>
                <td>Sumber Data</td>
                <td colspan="3">
        ...
        <table class="table">
            ...
            <tbody>
                <tr>
                    <td> <p style="font-size: 20px"><?php echo e($now); ?></p></td>
                    <td>
...
</script><?php /**PATH C:\xampp\htdocs\semerusmart2\resources\views/erm2/rm03.blade.php ENDPATH**/ ?>