    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" style="background-color:rgb(33, 65, 45);  box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
        <div class="container">
            <a class="navbar-brand text-light">
                <img src="<?php echo e(asset('public/img/semeru.png')); ?>" width="360" height="60" class="d-inline-block align-top ml-2 mr-2" alt="">
            </a>
...
</html><?php /**PATH C:\xampp\htdocs\electronicRM\resources\views/semeru/header.blade.php ENDPATH**/ ?>