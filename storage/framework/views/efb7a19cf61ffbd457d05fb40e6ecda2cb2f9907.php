    ...
    <!-- <div class="card-body container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <h4>RESUME DOKTER ( <?php echo e($ass_awal[0]->kode_kunjungan); ?> )</h4>
                </div>
                <table style="font-family:calibri" class="table table-md table-bordered text-md">
                    ...
                    <tbody>
                        <td>
                            <?php echo e($ass_awal[0]->tglwaktu_selesai); ?>
                        ...
                        <td>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <?php echo e($ass_awal[0]->dirujuk_ke); ?>
                        ...
                        <td>
                            <button class="btn btn-success editass_awal" kodekunjungan="<?php echo e($ass_awal[0]->kode_kunjungan); ?>"><i class="fas fa-pen"></i> | EDIT</button>
                        </td>
                    </tbody>
                </table>
                <table style="font-family:calibri" class="table table-md table-bordered text-md">
                    <h4>Resume Dokter ( <?php echo e($ass_kep[0]->kode_kunjungan); ?> )</h4>
                    ...
                    <tbody>
                        <td>
                            <?php echo e($ass_kep[0]->tgl_selesai); ?>
                        ...
                        <td>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <?php echo e($ass_kep[0]->evaluasi_perawat); ?>
                        ...
                        <td>
                            <button class="btn btn-success editass_kep align: middle" kodekunjungan="<?php echo e($ass_kep[0]->kode_kunjungan); ?>"><i class="fas fa-pen"></i> | EDIT</button>
                        </td>
                    </tbody>
                </table>
            </div>
