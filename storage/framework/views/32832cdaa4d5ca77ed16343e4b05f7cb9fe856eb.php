    ...
    <div class="card-body scroll2">
        ...
        <table class="table table-md text-md">
            ...
            <tr>
                ...
                <td><input readonly class="form-control form-control-md" value="<?php echo e($data[0]->tglwaktu_assesmen); ?>" id="tgldanjampengkajian_pasienbaru" name="edittgldanjampengkajian_pasienbaru"></td>
            </tr>
            <tr>
        ...
        <table class="table text-bold table-md text-md">
            ...
            <tbody>
                <tr class="text-center">
                    <td>
                        <textarea readonly disabled name="edittanggal_assesmen" class="form-control" id="tanggal_assesmen" cols="30" rows="2" value="<?php echo e($data[0]->tglwaktu_assesmen); ?>"></textarea>
                    </td>
                    ...
                    <td>
                        <div id="signature-pad">
                            <img width="200px" src="<?php echo e($data[0]->ttd_perawat); ?>" alt="">
                        </div>
                    </td>
                </tr>
            </tbody>
...
<div class="card card-light collapsed-card">
    ...
    <!-- /.card-body -->
</div><?php /**PATH C:\xampp\htdocs\electronicRM\resources\views/erm/riwayat_resume.blade.php ENDPATH**/ ?>